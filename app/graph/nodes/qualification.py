from app.services.availability_service import get_free_slots, find_matching_slot, book_slot
...
def qualification(state):
    ...
    if booking_stage == "offer_slots":
        ...
        book_result = book_slot(matched_slot)
        ...
        return {
            "collected_data": collected,
            "booking_stage": "ready",
            "answer": "Отлично, слот зафиксировал. Сохраняю заявку."
        }
